...
def _build_metadata__coco(
	...
	if labeling_platform == LabelingPlatform.ROBOFLOW:
		category_name2id = _build_category_name2id_coco__roboflow(annot_data['categories'])
	# else:
...
def _builder__coco(
	...
	metadata = _build_metadata__coco(annot_path=annot_path, labeling_platform=labeling_platform)
